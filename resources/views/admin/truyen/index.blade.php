        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <td class="navbar-brand">Liệt kê truyện</td>
                    <td >
                        <a type="button" href="{{ url('/truyen-tieu-thuyet/create') }}"class="btn btn-outline-info">
        ...
        <div class="card-body">
            ...
            <table class="table table-hover">
                ...
                <tr class="hover">
                    ...
                    <td>{{$t->name_novel}}</td>
                    <td><img src="{{asset('uploads/truyen/'.$t->image)}}" height="230" width="200"></td>
                    <td>{{$t->slug_novel}}</td>
                    <td>{{$t->author}}</td>
                    <td>{{$t->theloai->name_cate_novel}}</td>
                    <td>{{$t->danhmuc->name_category}}</td>
                ...
                <td >
                    <a href="{{route('truyen-tieu-thuyet.edit',[$t->id_novel])}}" class="btn btn-outline-info">
                    ...
                    <form action="{{route('truyen-tieu-thuyet.destroy',[$t->id_novel])}}" method="POST">
                        @method('DELETE')
                        @csrf
